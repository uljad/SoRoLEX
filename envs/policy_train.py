...
# checkpoint_name = "checkpoints/Oct-30-2023 09:59.pkl"
...
def make_train(config):
    ...
    # env_params = env.test_env_params
...
def main():
    wandb.init(project="Soft_RL_Sweep_2",config=config)
...
sweep_id = wandb.sweep(sweep=sweep_config, project="Soft_RL_Sweep_2")
